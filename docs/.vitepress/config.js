      ...
      '/01-مشاريع/': [
        {
          ...
          items: [
            ...
            { 
              text: '🎓 برنامج تدريبي AI',
              items: [
                { text: 'البرنامج الكامل', link: '/01-مشاريع/ai-research-training' },
                { text: 'اليوم 2: السياق', link: '/01-مشاريع/training-day2' },
                { text: 'اليوم 3: الكتابة', link: '/01-مشاريع/training-day3' },
                { text: 'اليوم 4: البرومبتات', link: '/01-مشاريع/training-day4' }
              ]
            }
          ]
        }
